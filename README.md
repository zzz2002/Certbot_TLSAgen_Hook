CerbotTLSAgen is a Certbot renew-hook designed to generate and automatically add and delete DNS TLSA records.\
...
1. **$RENEWED_LINEAGE** is the location of the new certs and keys.
...
When run in this mode two positional parameters are used:
